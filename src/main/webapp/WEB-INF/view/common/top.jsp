		...
		<ul class="nav">
			<c:choose>
				...
				<c:when test="${sessionScope.LOGIN_GENERAL != null}">
					<li class="nav-item"><a href="${pageContext.request.contextPath}/resource/images/yxy.jpg" height="30px" width="20px" target="_blank">
							<img alt="" src="/resource/images/yxy.jpg"
						...
						<div class="dropdown" style="padding-top: 0.4rem;">
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<a class="dropdown-item" href="/my/">个人主页</a> <a
									class="dropdown-item" href="#">个人设置</a> 
							  <a class="dropdown-item" href="javaScript:void(0)" id="article" data="/article/getTitles">我的文章</a>
