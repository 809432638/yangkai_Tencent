		...
		<dl>
			<dt>
				...
				<c:if test="${collects==null}">
				   <span class="glyphicon glyphicon-star-empty" data-article-id="${map.id }" onclick="collectArticle(this)" data-user-id="${sessionScope.LOGIN_GENERAL==null?0:sessionScope.LOGIN_GENERAL.id}"></span>
				</c:if>
				
				 <c:if test="${collects!=null}">
				    <span class="glyphicon glyphicon-star"  data-article-id="${map.id }" data-user-id="${sessionScope.LOGIN_GENERAL==null?0:sessionScope.LOGIN_GENERAL.id}" onclick="disCollect(this)"></span>
				 </c:if>
