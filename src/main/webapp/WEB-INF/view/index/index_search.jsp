		...
		<div class="row">
			...
			<div class="col-md-7 split min_h_500">
				...
				<c:if test="${article.channelId ==null }">
					...
					<div id="hot">
						...
						<!-- 新闻热点 -->
						<c:forEach items="${pageinfo.content}" var="cc">
							<div class="media">
								<img class="align-self-start mr-3"   width="150px" height="130px" src="/pic/${cc.picture}"
									alt="no pic">
								<div class="media-body">
									<h5 class="mt-0">
										<a href="javascript:detail(${cc.id })" style="${styles.styles}">${cc.title }</a>
									</h5>
									<p>${cc.content}</p>
									<p class="blog_item_footer">
									 <span class="glyphicon glyphicon-time" title="发布时间"></span>发布：&nbsp;
									   <fmt:formatDate value="${cc.updated}" pattern="yyyy-MM-dd HH:ss:mm"/>&nbsp;&nbsp;&nbsp;&nbsp;
									</p>
								</div>
							</div>
							<br />
			...
			<nav aria-label="...">
				  <ul class="pagination">
				     ...
				     <li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/search?key=${key}&page=1">首页</a>
				    </li>
				  
				    <li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/search?key=${key}&page=${page-1>0?page-1:1}">上一页</a>
				    </li>
				   
				    <li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/search?key=${key}&page=${page+1>pageInfo.totalPages?pageInfo.totalPages:page+1}">下一页</a>
				    </li>
				    
				     <li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/search?key=${key}&page=${pageInfo.totalPages}">尾页</a>
				    </li>
				  </ul>
			</nav>
					</div>
