...
<body>
				...
				<c:if test="${article.channelId ==null }">
					...
					<div id="hot">
						<div id="carousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="/pic/pic/1.jpg" alt="First slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="/pic/pic/2.jpg" alt="Second slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="/pic/pic/3.jpg" alt="Third slide">
								</div>
							</div>
						...
						<c:forEach items="${hotArticles}" var="c">
							<div class="media" >
								<img class="align-self-start mr-3" width="150px" height="130px" src="/pic/${c.picture } "
									alt="no pic">
			    ...
			    <div class="card">
					...
					<ol>
						...
						<c:forEach items="${linkList}" var="l">
							<li class="text-truncate text-center"><a href="${pageContext.request.contextPath}/${l.url }"
	...
	<script type="text/javascript">
		...
		function detail(id) {
			...
			window.open("${pageContext.request.contextPath}/article/get?id=" + id, "_blank")
		}
		...
		function getPic(id) {
			...
			//	 window.open("/getArticleDetail?id="+id);
			window.open("${pageContext.request.contextPath}/pics/select?id=" + id, "_blank")
		}
	</script>
</body>
</html>